...
// Source: streamgate/pkg/storage (interfaces: Cache)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_cache.go -package=mocks streamgate/pkg/storage Cache
//
...
func (m *MockCache) SetWithExpiration(ctx context.Context, key, value string, expiration time.Duration) error {
	m.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SetWithExpiration(ctx, key, value, expiration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetWithExpiration", reflect.TypeOf((*MockCache)(nil).SetWithExpiration), ctx, key, value, expiration)
}
