...
// Source: streamgate/pkg/storage (interfaces: UserRepository)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_user_repository.go -package=mocks streamgate/pkg/storage UserRepository
//
...
func (m *MockUserRepository) GetUser(ctx context.Context, username string) (*models.User, error) {
	m.ctrl.T.Helper()
